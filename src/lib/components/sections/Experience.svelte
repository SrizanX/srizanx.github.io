...
<!-- Declared at the top level, not inside <Section> — a snippet placed directly inside a
	component is passed to it as a prop rather than staying local to this file. -->
